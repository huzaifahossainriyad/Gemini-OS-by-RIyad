...
const App: React.FC = () => {
  ...
  const handleAppOpen = (app: AppDefinition) => {
    ...
    if (isStatefulnessEnabled && appContentCache[cacheKey]) {
      ...
      internalHandleLlmRequest(newHistory, currentMaxHistoryLength, language);
    }
  };
  ...
  const handleGoBack = () => {
    ...
    const newPath = currentAppPath.slice(0, -1);
    const newHistory = interactionHistory.slice(1);
  ...
  return (
    <div className="bg-white w-full min-h-screen flex items-center justify-center p-4">
      <Window
        ...
        canGoBack={currentAppPath.length > 1}>
        <div
